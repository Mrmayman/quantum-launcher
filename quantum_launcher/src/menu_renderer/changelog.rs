...
pub fn changelog_0_3_1<'a>() -> Element<'a> {
    widget::column!(
        ...
        "- Added Quilt support",
        "- Added Omniarchive integration (downloading old, rare versions of Minecraft)",
        "- Added a new style (Sky blue). Try it in Settings -> Style",
        "- Added a cool ascii art intro in the terminal",
        widget::text("Mods:").size(20),
        "- Added mod presets!",
        "-- You can now share your mod configurations with others",
        "-- You can also download recommended mods",
        "- Now you can copy mod ID or open the mod page in the mod store",
        ...
        "- Added (experimental) support for Linux ARM64 (early alpha), started work on macOS support",
        widget::text("Fixes and polish:").size(20),
        "- There is now a confirmation for uninstalling loaders",
